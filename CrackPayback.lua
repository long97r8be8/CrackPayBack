...
local Main = Library:Tab("        Chính","rbxassetid://14764164264",_G.ColorMain)
    local Setting = Library:Tab("        Cài Đặt","rbxassetid://14782648917",_G.ColorSetting)
    local AutoQuest = Library:Tab("        Nhiệm vụ & trang bị","rbxassetid://9606626859",_G.ColorQuest)
    local Stats = Library:Tab("        tự động chỉ số","rbxassetid://14764174048",_G.ColorStats)
    local Sea = Library:Tab("        Sự Kiện Biển","rbxassetid://15412636044",_G.ColorSea)
    local Combat = Library:Tab("        Đấm nhau","rbxassetid://14764193934",_G.ColorCombat)
    local Teleport = Library:Tab("        Dịch chuyển","rbxassetid://14764218351",_G.ColorTP)
    local Dungeon = Library:Tab("        Tập Kích","rbxassetid://14764250087",_G.ColorRaid)
    local Race = Library:Tab("        Tộc V4","rbxassetid://11446900930",_G.ColorRace)
    local DevilFruit = Library:Tab("        Trái Ác quỷ","rbxassetid://14764233722",_G.ColorDF)
    local Shop = Library:Tab("        Hàng","rbxassetid://14764242920",_G.ColorShop)
local Misc = Library:Tab("        Ko bt dịch+định vị","rbxassetid://11447063791",_G.ColorMisc)
